    ...
    <nav class="nav-right">
      <div class="nav-group">
        ...
        if (isset($_SESSION["login_session"]) && $_SESSION["login_session"] == true) {
          ...
          $userimg = $row['profile'];
          $uuid = $row["uuid"];
          $notify_query = $link->query("SELECT * FROM `notifications` where user='$uuid' and status='unread' ORDER BY created_at DESC");
          ...
          <div class="userinfo" id="userinfo">
            <ul id="memberArea" class="userinfo-card">
              <li>
                <?php
                if ($row['profile'] == null) {
                  echo "<img src='" . DEFAULT_AVATAR . "' class='rounded-circle img-thumbnail' width='65px' height='65px'>";
                } else {
                  echo "<img src='$userimg' class='rounded-circle img-thumbnail' width='65px' height='65px'>";
                }
                echo <<<EOT
                 <font size=4px>
              ...
              <hr>
              <li><a href="logout.php"><i class="fa fa-outdent" style="font-size:15px"></i>&nbsp;&nbsp;登出</a></li>
            </ul>
          </div>
        ...
        <?php
          ...
          include_once 'login/google_login.php';
        ?>
            ...
            <div class="form-box login">
              ...
              <form action="login.php" method="post">
                ...
                <div class="login-register">
                  <a id="authUrl" href="<?php echo $authUrl; ?>"><i class="fa-brands fa-google social"></i></a>
            ...
            <div class="form-box register">
              ...
              <form action="register.php" method="post">
                <div class="input-box">
                  ...
                  <input type="text" maxlength="10" name="Username" required>
                  <label>使用者名稱</label>
                </div>
                <div class="input-box">
                  <span class="icon"><i class='bx bxs-envelope'></i></span>
                ...
                <div class="input-box">
                  <span class="icon"><i class='bx bxs-lock-alt'></i></span>
                  <input type="password" minlength="8" maxlength="10" name="Password" required>
                  <label>密碼</label>
                </div>
                <div class="input-box">
                  <span class="icon"><i class='bx bxs-lock-alt'></i></span>
                  <input type="password" minlength="8" maxlength="10" name="Re_Password" required>
                  <label>確認密碼</label>
                </div>
