          ...
          <div class="content">
            <div class="content-left">
              <div class="category-group">
                ...
                $category = $link->query("SELECT *  FROM favoriteboards INNER JOIN category ON  favoriteboards.board_id = category.category_id limit $offset,$pageSize");
                $totalsql = $link->query("SELECT * FROM favoriteboards");
              ...
              <div class="category-page">
                ...
                if ($page != 1) { // 判斷不在第一頁時才顯示下一頁箭頭
                  echo " <a class='prev' href='favoriteboards?page=$prev' style='text-decoration:none'>
                ...
                for ($i = 1; $i <= $totalpage; $i++) {
                  if ($i == $page) {
                    ...
                    echo "<a href='favoriteboards?page=$i' style='text-decoration:none;cursor:pointer'>$i</a> ";
                  }
                }

                // 下一頁
                if ($page < $totalpage) { // 只有當前頁小於總頁數時才顯示下一頁箭頭
                  echo "<a class='next' href='favoriteboards?page=$next' style='text-decoration:none'>
